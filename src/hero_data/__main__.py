...
def main(arg=None):
    ...
    Args:
    - arg (str, optional): Argument to specify a particular section. Default is None.
    """
    if arg == "easteregg":
        # Execute the Easter egg functionality
        print("Wow! You found the secret Easter egg!")
        # Adjust the height of the tree here (even numbers work better)
        tree_height = 10
...
def draw_christmas_tree(height):
    ...
    print(" " * (height - 2) + "| |")  # Trunk of the tree
